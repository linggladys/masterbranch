...
$link2 = mysqli_connect("localhost", "root", "", "gamereviewwebsite");
...
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result)>0){
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            print $review_num. ' <i style="color:#c9d3fc;" class="fa fa-star"></i></span><div class="divider p-1"></div>';

            print '<div class="reviews"><p class="fs-5">'.$user_review."</div>";
...
//    $user_review = mysqli_real_escape_string($link2, $_POST['user_review']);
//    $review_num = mysqli_real_escape_string($link2, $_POST['review_num']);
//
//    $query = "INSERT INTO reviewsnew (user_review,review_num)
//VALUES ('$user_review','$review_num')";
...
//    } else {
//        echo 'ERROR: Could not able to execute $query.' . mysqli_error($link2);
//    }
//}
